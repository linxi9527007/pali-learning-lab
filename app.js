...
async function forceClearAllCaches(){
  try{
    ...
    location.href='./index.html?v=20.34&cache=cleared&ts='+Date.now();
  }catch(e){
...
(function(){
  ...
  window.addEventListener('DOMContentLoaded',function(){document.querySelectorAll('button').forEach(b=>{if(!b.type)b.type='button';});const badge=document.querySelector('.visual-version-badge');if(badge)badge.textContent='Pāli Learning Lab · 20.34 加速修正版';updateLessonNav();renderGlobalSearchFull();});
...
(function(){
  ...
  window.addEventListener('DOMContentLoaded',function(){
    ...
    if(badge)badge.textContent='Pāli Learning Lab · 20.34 加速修正版';
...
(function(){
  const VERSION_LABEL_184 = "Pāli Learning Lab · 20.34 加速修正版";
...
(function(){
  const VERSION_LABEL_185 = "Pāli Learning Lab · 20.34 加速修正版";
...
(function(){
  const VERSION_LABEL_186 = "Pāli Learning Lab · 20.34 加速修正版";
...
(function(){
  const VERSION_LABEL_187 = "Pāli Learning Lab · 20.34 加速修正版";
...
(function(){
  const VERSION_LABEL_188 = "Pāli Learning Lab · 20.34 加速修正版";
...
(function(){
  const VERSION_LABEL_189 = "Pāli Learning Lab · 20.34 加速修正版";
...
(function(){
  const VERSION_LABEL_190 = "Pāli Learning Lab · 20.34 加速修正版";
...
(function(){
  const VERSION_LABEL_191 = "Pāli Learning Lab · 20.34 加速修正版";
...
(function(){
  const VERSION_LABEL_192 = "Pāli Learning Lab · 20.34 加速修正版";
...
(function(){
  const VERSION_LABEL_193 = "Pāli Learning Lab · 20.34 加速修正版";
...
(function(){
  const VERSION_LABEL_197 = "Pāli Learning Lab · 20.34 加速修正版";
...
(function(){
  const VERSION_LABEL_198 = "Pāli Learning Lab · 20.34 加速修正版";
...
(function(){
  const VERSION_LABEL_199 = "Pāli Learning Lab · 20.34 加速修正版";
...
(function(){
  const VERSION_LABEL_201 = "Pāli Learning Lab · 20.34 加速修正版";
...
(function(){
  const VERSION_LABEL_202 = "Pāli Learning Lab · 20.34 加速修正版";
...
(function(){
  const VERSION_LABEL_2013 = "Pāli Learning Lab · 20.34 加速修正版";
...
(function(){
  const VERSION_LABEL_2014 = "Pāli Learning Lab · 20.34 加速修正版";
...
(function(){
  const VERSION_LABEL_2018 = "Pāli Learning Lab · 20.34 加速修正版";
  const DATA_2018 = {
...
(function(){
  const VERSION_LABEL_2019 = "Pāli Learning Lab · 20.34 加速修正版";
...
(function(){
  const VERSION_LABEL_2020 = "Pāli Learning Lab · 20.34 加速修正版";
  const INDEX_URL_2020 = "grammar-index.json?v=20.34";
  const MANIFEST_URL_2020 = "grammar-lesson-manifest.json?v=20.34";
  ...
  async function ensureLesson2020(id){
    ...
    lessonPromises2020[id] = manifest2020().then(map => {
      ...
      return fetch(LESSON_BASE_2020 + fname + "?v=20.34", {cache:"no-store"});
    }).then(r => {
...
(function(){
  const VERSION_LABEL_2021 = "Pāli Learning Lab · 20.34 加速修正版";
...
(function(){
  const VERSION_LABEL_2022 = "Pāli Learning Lab · 20.34 加速修正版";
  const MODULE_DIRECTORY_URL_2022 = "grammar-module-directory.json?v=20.34";
  ...
  async function ensureModuleIndex2022(moduleName){
    ...
    modulePromises2022[moduleName] = fetch(MODULE_BASE_2022 + entry.file + "?v=20.34", {cache:"no-store"})
      .then(r => {
...
(function(){
  const VERSION_LABEL_2023 = "Pāli Learning Lab · 20.34 加速修正版";
  const EXERCISE_URL_2023 = "exercise-index.json?v=20.34";
...
(function(){
  const VERSION_LABEL_2024 = "Pāli Learning Lab · 20.34 加速修正版";
  const SEARCH_URL_2024 = "search-index.json?v=20.34";
...
(function(){
  const VERSION_LABEL_2026 = "Pāli Learning Lab · 20.34 加速修正版";
...
/* ===== Pali Grammar 20.34: force final version label ===== */
(function(){
  const FINAL_LABEL = "Pāli Learning Lab · 20.34 加速修正版";
  function forceFinalVersion(){
    const badge = document.querySelector(".visual-version-badge");
    if(badge) badge.textContent = FINAL_LABEL;
    document.documentElement.setAttribute("data-pali-version", "20.34");
  }
  ...
  window.__paliForceVersion2029 = {version:"20.34", label:FINAL_LABEL, force:forceFinalVersion};
})();


/* ===== Pali Grammar 20.34: final redeploy version label ===== */
(function(){
  const FINAL_LABEL = "Pāli Learning Lab · 20.34 加速修正版";
  function forceFinalVersion(){
    const badge = document.querySelector(".visual-version-badge");
  ...
  setTimeout(forceFinalVersion, 500);
  setTimeout(forceFinalVersion, 1500);
  window.__paliForceVersion2030 = {version:"20.34", label:FINAL_LABEL, force:forceFinalVersion};
})();


/* ===== Pāli Learning Lab 20.34: route/order/plain-body-terms/vocabulary final patch ===== */
(function(){
  const LABEL_2031 = "Pāli Learning Lab · 20.34 加速修正版";
  ...
  function setBadge2031(){const b=document.querySelector(".visual-version-badge"); if(b)b.textContent=LABEL_2031; document.documentElement.setAttribute("data-pali-version","20.34");}
  ...
  window.addEventListener("DOMContentLoaded",()=>{
    setBadge2031();
    ensureData2031(["routes"]).then(()=>ensureIndex2031()).then(()=>{try{if(typeof stats==="function")stats();}catch(e){};});
  });
})();


/* ===== Pāli Learning Lab 20.34: display cleanup + direct glossary navigation ===== */
(function(){
  const LABEL_2032 = "Pāli Learning Lab · 20.34 加速修正版";
...
/* ===== Pāli Learning Lab 20.34: display cleanup, fixed lesson order, glossary routing, categorized search ===== */
(function(){
  const VERSION_2033 = "20.34";
  const LABEL_2033 = "Pāli Learning Lab · 20.34 加速修正版";
  ...
  async function searchIndex(){
    ...
    try{const r=await fetch('search-index.json?v=20.34',{cache:'no-store'}); if(r.ok){window.__searchIndex2033=await r.json();return window.__searchIndex2033;}}catch(e){}
    return grammarList();
  }
  ...
  let __searchTimer2034=null;
  document.addEventListener('input',function(e){
    if(e.target&&e.target.id==='searchInput'){
      const value=e.target.value;
      clearTimeout(__searchTimer2034);
      __searchTimer2034=setTimeout(()=>renderCategorizedSearch(value),180);
    }
  },true);
...
/* ===== Pāli Learning Lab 20.34: speed-only final patch ===== */
(function(){
  const SPEED_LABEL="Pāli Learning Lab · 20.34 加速修正版";
  function byId(id){return document.getElementById(id)}
  function setSpeedBadge(){
    document.documentElement.setAttribute("data-pali-version","20.34");
    document.querySelectorAll(".visual-version-badge").forEach(el=>{el.textContent=SPEED_LABEL;});
  }
  setSpeedBadge();
  window.addEventListener("DOMContentLoaded",setSpeedBadge,{once:false});
  window.addEventListener("load",setSpeedBadge,{once:false});

  // Global search should not rebuild large indexes on every keystroke.
  const oldRenderGlobal = window.renderGlobalSearchFull;
  let globalTimer=null;
  window.renderGlobalSearchFull=function(){
    const input=byId("globalSiteSearchInput");
    const box=byId("globalSiteSearchResults");
    if(!input||!box){ if(typeof oldRenderGlobal==='function') return oldRenderGlobal(); return; }
    const q=(input.value||"").trim();
    if(!q){box.innerHTML='<div class="global-search-empty">输入关键词后显示全站结果。</div>';return;}
    if(q.length<2){box.innerHTML='<div class="global-search-empty">请至少输入 2 个字符再搜索。</div>';return;}
    clearTimeout(globalTimer);
    globalTimer=setTimeout(()=>{ if(typeof oldRenderGlobal==='function') oldRenderGlobal(); },220);
  };

  // Keep search useful but avoid heavy repeated rendering while typing.
  const oldGrammarSearch=window.renderGrammarSearch;
  let grammarTimer=null;
  window.renderGrammarSearch=function(){
    const input=byId("searchInput");
    const box=byId("searchResults");
    const q=(input&&input.value||"").trim();
    if(!q){ if(box)box.innerHTML='<p class="muted">输入关键词后显示分类搜索结果。</p>'; return; }
    if(q.length<2){ if(box)box.innerHTML='<p class="muted">请至少输入 2 个字符再搜索。</p>'; return; }
    clearTimeout(grammarTimer);
    grammarTimer=setTimeout(()=>{ if(typeof oldGrammarSearch==='function') oldGrammarSearch(); },160);
  };

  // Utility for future checks: tells whether heavy data has been loaded.
  window.__paliSpeed2034={version:"20.34",label:SPEED_LABEL,heavyDataLoaded:function(){
    return {
      sentence:!!window.SENTENCE_ANALYSIS_DATA,
      token:!!window.TOKEN_ANALYSIS_DATA,
      terminology:!!window.TERMINOLOGY_GLOSSARY,
      buddhistReading:!!window.BUDDHIST_READING_PATTERNS
    };
  }};
})();
